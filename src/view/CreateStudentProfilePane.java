...
public class CreateStudentProfilePane extends GridPane {
	...
	private Label lblMessage; // shows errors and messages etc
	...
	public CreateStudentProfilePane() {
		...
		lblMessage.setTextFill(Color.web("#ff0000")); // sets the message label to RED color by default.
	...
	/**
	 * This accesses the lblMessage label control and modifies the text property.
